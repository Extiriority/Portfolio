...
<section class="grid gap-4 pb-20 justify-center"
    ...
    <div class="min-h-[375px] pt-28 w-[333px] sm:w-96 md:w-[500px] lg:w-[1100px] xl:w-[1280px]">
        {#if isInView}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 pt-6">
                {#each projects as project (project.id)}
                    <div class="flex flex-col">
                        <div in:fly={{delay: 250, y: 40, duration: 300}} class="relative flex bg-bkg shadow-lg rounded-t-3xl overflow-hidden transform transition duration-300 lg:hover:scale-105 hover:rounded-3xl hover:shadow-xl h-[300px] md:h-[350px] lg:h-[245px]">
                            {#if project.isVideo}
                                <video class="absolute opacity-20 hover:opacity-100 transition ease-in-out object-cover w-full h-[300px] md:h-[350px] lg:h-[245px]" src={project.banner} playsinline loop autoplay muted></video>
                            {:else}
                                <img class="absolute opacity-20 hover:opacity-100 transition ease-in-out object-cover w-full h-[300px] md:h-[350px] lg:h-[245px]" src={project.banner} alt={project.title}>
                            {/if}
