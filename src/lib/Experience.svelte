<script lang="ts">
    ...
    import iPost from "../assets/iPost.mp4";
    ...
    let projects = [
        {
            ...
            techStack: "Kotlin, PostgresSQL Next.js, TypeScript, TailwindCSS, Docker",
            banner: CMBanner,
            isVideo: false,
            logo: CM,
            link: "https://cm.com/",
        ...
        },
        {
            ...
            techStack: "C#, .NET6, TypeScript, VueJS, SCSS, postgresSQL, Azure, K8s, rabbitMQ, Cypress, SonarCloud",
            banner: iPost,
            isVideo: true,
            logo: CM,
    ...
    <div class="min-h-[375px] pt-28 container">
        {#if isInView}
            ...
            {#each projects as project (project.id)}
                <div in:fly={{delay: 250, y: 40, duration: 300}} class="relative flex bg-gray-700 mb-10 shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-xl">
                    {#if project.isVideo}
                        <video class="absolute opacity-10 hover:opacity-100 transition ease-in-out w-full h-72 object-cover" src={project.banner} autoplay muted loop></video>
                    {:else}
                        <img class="absolute opacity-10 hover:opacity-100 transition ease-in-out w-full h-72 object-cover" src={project.banner} alt={project.title}>
                    {/if}
                    <div class="p-6">
                        ...
                        <div class="flex justify-between mt-auto pt-4">
                            ...
                            <p class="text-xs font-mono pt-3 text-touch w-72">{project.techStack}</p>
