...
<div class="container  py-4">
    ...
    <div in:fly={{delay: 1000, x: -40, duration: 250}} class="font-bold text-muted text-3xl md:text-5xl lg:text-5xl pt-5">
        I build things for the web.
    </div>
    <div in:fly={{delay: 1200, x: -40, duration: 250}} class="font-thin md:text-lg text-muted pt-8 sm:w-3/4 lg:w-3/4 2xl:1/2 italic">
        I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences.
        Currently, I’m focused on building accessible portfolio to show of my work.
    </div>
</div>